...
def detectParcel():
	...
	dist = measureDistance()  	
  	...
  	if dist-tolerance>=threshold:
		...
		print 'I see a parcel but I should do nothing'		
		return False			
		'''
		
	if dist + tolerance <= threshold and detected == False:
		detected=True
		return True
		
	elif dist + tolerance > threshold:		
		detected = False		
	
	##this should be removed in production
	if dist + tolerance <= threshold and detected == True:
